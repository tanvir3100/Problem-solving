// You need to know that delete is not a method, it is an operator.
// It is used to delete a property from an object.

// It dose not change the length of the array.
